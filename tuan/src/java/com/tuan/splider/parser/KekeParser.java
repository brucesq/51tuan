 ...
 *
 */
public class KekeParser  implements ArticleParser {
	...
	public static void parserContent(String content, Article article) {
		int index = content.indexOf("class=\"p_name\"");
		if (index > 0) {
...
//				System.out.println(title);
		...
		index = content.indexOf("class=\"l price\"");
		if (index > 0) {
...
//						 System.out.println(saveMoney);
					...
					index = content.indexOf("class=\"r deal_r\"");
					if (index >= 0) {
						content = content.substring(index + 15);
...
//						 System.out.println("http://www.cocotuan.com"+ url);
						if(url.indexOf("http")>=0){
							article.setImgurl( url);
						}else{
							article.setImgurl("http://www.cocotuan.com"+ url);
						}
	...
	public static void main(String[] args)throws Exception {
		KekeParser p = new KekeParser();
			p.parse("http://www.cocotuan.com/BeiJing.aspx", 1, 5);
	}
}
