 ...
 *
 */
public class JuziParser   implements ArticleParser {
...
//						 System.out.println("http://www.liketuan.com"+ url);
						if(url.indexOf("http")>=0){
							article.setImgurl( url);
						}else{
							article.setImgurl("http://www.liketuan.com"+ url);
						}
	...
	public static void main(String[] args)throws Exception {
		JuziParser p = new JuziParser();
			p.parse("http://www.liketuan.com/index.php?m=Index&a=index&cityname=beijing_2", 1, 5);
	}
}
